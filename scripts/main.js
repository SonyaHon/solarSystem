...
function init() {
    ...
    var earthScene = new createScene([
            new spaceObj({
                texture: "imgs/texture_earth.jpg",
                size: EARTH_SIZE,
                orbitRotationSpeed: EARTH_YEAR,
                orbitCoef: 1,
                info: infos.earth,
                name: "earth"
            }),
            new spaceObj({
                texture: "imgs/texture_moon.jpg",
                size: 0.2 * EARTH_SIZE,
                info: infos.moon,
                orbitRotationSpeed: EARTH_YEAR,
                orbitCoef: 1,
    ...
    var mercuryScene = new createScene([
            new SpaceObj({texture: "imgs/texture_mercury", size: EARTH_SIZE / 3,
    ...
    scenes['mercury'] = mercuryScene;

    var mainScene = new createScene([
            new spaceObj({
                texture: "imgs/texture_sun.jpg",
                size: 109 * EARTH_SIZE / 3,
                isLightSource: true,
                info: infos.sun,
                name: "sun"
            }),
            new spaceObj({
                texture: "imgs/texture_mercury.jpg",
                size: EARTH_SIZE / 3,
                x: 0.5 * ASTRO_ONE,
            ...
            new spaceObj({
                texture: "imgs/texture_venus.jpg",
                size: EARTH_SIZE * 0.95,
                x: ASTRO_ONE * 0.75,
            ...
            new spaceObj({
                texture: "imgs/texture_jupiter.jpg",
                size: EARTH_SIZE * 12.5,
                x: ASTRO_ONE * 2,
            ...
            new spaceObj({
                texture: "imgs/texture_saturn.jpg",
                size: EARTH_SIZE * 10,
                x: ASTRO_ONE * 3,
            ...
            new spaceObj({
                texture: "imgs/texture_urane.jpg",
                size: EARTH_SIZE * 4,
                x: ASTRO_ONE * 4,
            ...
            new spaceObj({
                texture: "imgs/texture_neptune.jpg",
                size: EARTH_SIZE * 4,
                x: ASTRO_ONE * 4.5,
